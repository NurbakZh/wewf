document.addEventListener("DOMContentLoaded", function() {
    var script = document.getElementById('e6f4be307578943bde0d17fa428a59027c0dbf46');
    ...
    iframe.className = '636';
    iframe.id = '5d39fb967502573f4298cc07f4561bf310044ad6' + '_' + iframe.className;
    ...
    var gcEmbedOnMessage = function(e) {
        ...
        if (e.data.uniqName == 'e6f4be307578943bde0d17fa428a59027c0dbf46') {
            if (e.data.height) {
