document.addEventListener("DOMContentLoaded", function() {
    var script = document.getElementById('69e430df9bd5ded38040041eb07a60cb8d1c3b37');
    ...
    iframe.className = '474';
    iframe.id = '0c364466ae1f48a295b9934684f710455e54a341' + '_' + iframe.className;
    ...
    var gcEmbedOnMessage = function(e) {
        ...
        if (e.data.uniqName == '69e430df9bd5ded38040041eb07a60cb8d1c3b37') {
            if (e.data.height) {
